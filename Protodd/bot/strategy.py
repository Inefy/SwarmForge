...
DIMS = {'gates_open': ['gate2', 'gate1', 'gate4'], 'location': ['home', 'proxy'], 'gas_open': ['one_gas', 'no_gas', 'two_gas'], 'aggression': ['standard', 'early', 'very_early', 'late', 'very_late'], 'greed': ['standard', 'greedy', 'lean'], 'tech': ['blink_stalker', 'immortal_core', 'chargelot'], 'army': ['gateway', 'robotics', 'sky', 'mixed']}
