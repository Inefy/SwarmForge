"""
Open-ended per-opponent learning for Battencruiser, persisted via ./data.
...
game, and every game is appended to data/games_battencruiser.jsonl for analysis.
"""
...
OPENINGS = ['three_rax', 'bio_macro', 'proxy_2rax']
...
RUSH_UNSAFE_OPENING = 'proxy_2rax'
...
TECH_ARMS = ['tank_bio', 'marine_bio', 'marauder_bio']
